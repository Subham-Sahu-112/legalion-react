...
export default function Contact() {
  ...
  const getDirections = () => {
    window.open(
      "https://www.google.com/maps/dir//Plot+10%2F10,+Anantam+Residency,+Sabar+sahi,+Rasulgarh,+Bhubaneswar-751010",
      "_blank"
    );
  };
...
🕒 ${new Date().toLocaleString("en-IN", { timeZone: "Asia/Kolkata" })}
  ...
  return (
    <div className="route-contact-page">
      <Navbar />
      <section id="contact" className="route-contact">
        <div className="route-container">
          <div className="route-contact-header">
            <div className="route-section-badge">
            ...
            <h2 className="route-section-title">
              Let's Start Your&nbsp;
              <span className="route-gradient-text">Success Journey</span>
            </h2>
          ...
          <div className="route-contact-container">
            <div className="route-contact-info">
              <div className="route-contact-details">
                <div className="route-contact-item">
                  <div className="route-contact-icon">
                    <i className="fas fa-phone"></i>
                  </div>
                  <div className="route-contact-content">
                    <h4>Phone</h4>
                    <p>+91 9945293599</p>
                  </div>
                </div>
            ...
            <div className="route-contact-form-container">
              <form
                className="route-contact-form"
                id="contactForm"
              ...
              >
                ...
                >
                  ...
                  <i
                    className={`fas ${
                      isSubmitting ? "fa-spinner fa-spin" : "fa-whatsapp"
                    }`}
                  ></i>
                </button>
              </form>
              ...
              <div className="route-map-wrapper">
                ...
                <div className="route-map-overlay">
                  <div className="route-location-info">
                    <div className="route-location-icon">
                      <i className="fas fa-map-marker-alt"></i>
                    </div>
                    <div className="route-location-details">
                      ...
                      <div className="route-location-actions">
                        <a
                          ...
                          className="route-btn route-btn-outline route-btn-sm"
                        >
                          <i className="fas fa-external-link-alt"></i>
                          Open in Google Maps
                        </a>
                        <button
                          className="route-btn route-btn-primary route-btn-sm"
